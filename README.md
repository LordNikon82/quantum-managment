...
- `.env` – runtime configuration loaded by Compose.
...
1. Create a `.env` file in the repository root (`quantum-managment/.env`) if it does not already exist. Start from the snippet below and adjust values to your environment:
   ```dotenv
